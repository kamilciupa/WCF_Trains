...
namespace TrainClient.ServiceReference1 {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="CompositeType", Namespace="http://schemas.datacontract.org/2004/07/TrainsServ")]
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<TrainClient.ServiceReference1.IService1>, TrainClient.ServiceReference1.IService1 {
        ...
        public string[] GetTripWithoutTime(string From, string To) {
            return base.Channel.GetTripWithoutTime(From, To);
        }
        
        public System.Threading.Tasks.Task<string[]> GetTripWithoutTimeAsync(string From, string To) {
